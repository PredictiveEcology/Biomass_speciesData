...
test_that("parameters are the expected names", {
  ...
  expect_identical(
    ...
    sort(c(".plotInitialTime", ".plotInterval", ".plots", ".saveInitialTime",
           ".saveInterval", ".sslVerify", ".studyAreaName", ".useCache", ".useParallel",
           "coverThresh", "dataYear", "sppEquivCol", "types", "vegLeadingProportion"))
  )
})
