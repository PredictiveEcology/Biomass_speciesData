...
Require(c("dplyr", "data.table", "PredictiveEcology/LandR"), upgrade = FALSE, install = FALSE)
```
...
Please report any discrepancies or omissions at <https://github.com/PredictiveEcology/Biomass_speciesData/issues>.
:::
...
knitr::kable(df_inputs,
  ...
  kableExtra::kable_styling(latex_options = c("scale_down", "repeat_header"), full_width = FALSE) %>%
